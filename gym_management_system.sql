...
CREATE TABLE `member`  (
  ...
  `card_class` int NULL DEFAULT NULL COMMENT '充值额度',
  `card_next_class` int NULL DEFAULT NULL COMMENT '卡上余额',
...
CREATE TABLE `employee`  (
  `employee_account` int NOT NULL COMMENT '教练账号',
  `employee_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '教练姓名',
  `employee_gender` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '教练性别',
  `employee_age` int NULL DEFAULT NULL COMMENT '教练年龄',
...
INSERT INTO `employee` VALUES (101058973,  '保洁1', '女', 48, '2019-08-24', '保洁员', '模范教练');
